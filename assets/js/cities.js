...
for (const city of cities) {  
    ...
    cityCell.innerHTML = city.city;
    row.appendChild(cityCell);

    const famousForCell = document.createElement('td');
    famousForCell.innerHTML = city.famousFor;
    row.appendChild(famousForCell);

    const typeCell = document.createElement('td');
    typeCell.innerHTML = city.type;
    row.appendChild(typeCell);

    const plateNumberCell = document.createElement('td');
    plateNumberCell.innerHTML = city.plateNumber;
